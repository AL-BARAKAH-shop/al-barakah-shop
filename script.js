...
const products=[
  ...
  },
  {
    id:34,
	//stock:false,
    name:"Mini Honey Nut Box পাইকারি– ১৮ গ্রাম +-১গ্রাম ",
    cat:"অর্গানিক ফুড",
    price:16,
    discount:0,
    ...
    short:"হানি নাট 18gm mini Box পাইকারি সর্বনিম্ন অর্ডার ১০০পিস",
...
function renderCheckout(){
  ...
  const area =
    document.getElementById("deliveryArea")?.value === "outside"
      ? "ঢাকার বাইরে"
      : "ঢাকার ভেতর";
...
const ALBA_OFFER = {
  ...
  endTime:   "2026-09-20T24:00:00+06:00",
  ...
  // ===================================================
  categories: ["ওয়াল ল্যাম্প", "টেবিল ল্যাম্প", "ডেকোরেটিভ আইটেম"],
...
function albaUpdateOffer(){
  ...
  if(
    ...
    if(title){
      ...
      title.textContent =
        "নির্দিষ্ট পণ্যের উপড় বিশেষ ছাড়!";
    }
